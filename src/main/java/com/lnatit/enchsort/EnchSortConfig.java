...
public class EnchSortConfig {
    ...
    public static ModConfigSpec.BooleanValue ALSO_SORT_BOOK;
    ...
    public static ModConfigSpec.ConfigValue<List<String>> MAX_LEVEL_FORMAT;
    public static ModConfigSpec.BooleanValue HIGHLIGHT_TREASURE;
    public static ModConfigSpec.ConfigValue<List<String>> TREASURE_FORMAT;
    ...
    private static Style parseFormatList(List<String> formats) {
        ...
        for (String fElement : formats) {
            ...
            var color = TextColor.parseColor(fElement);
            Optional<TextColor> result = color.result();

            if (result.isPresent()) {
                style = style.withColor(result.get());
                continue;
            }
